...
//globals
int32_t     t_fine;
char comp_data[34] = {0};//compensation data readed into this
char burst_read_data[8] = {0};//in loop measured data readed into this
...
//dbg
usartSend("\r\ncomp_data: ", 2);
for(int ho = 0; ho<34; ho++)
{
  usart_send_blocking(USART2, comp_data[ho]);
  usartSend(" ", 2);
}
usartSend(" konec dat\r\n", 2);
